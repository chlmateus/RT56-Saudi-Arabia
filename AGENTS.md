...
- `RT56: Saudi Arabia`: full mod name used in prose.
- `[MOD_PREFIX]`: short script prefix, namespace, or internal identifier prefix.
- `"C:\Users\chlma\Documents\Paradox Interactive\Hearts of Iron IV\mod\RT56Saudi Arabia\paradox_wiki"`: path to the offline Paradox wiki snapshot.
- `D:\SteamLibrary\steamapps\common\Hearts of Iron IV`: path to the local vanilla Hearts of Iron IV install.
- `D:\SteamLibrary\steamapps\common\Hearts of Iron IV\documentation`: documentation folder, usually `docs/`.
